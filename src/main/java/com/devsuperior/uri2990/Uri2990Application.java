...
public class Uri2990Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		List<EmpregadoDeptProjection> list1 = repository.serch1();
		...
		List<EmpregadoDeptDTO> result2 = repository.serch2();
		...
		List<EmpregadoDeptProjection> list3 = repository.serch3();
